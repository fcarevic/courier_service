...
/*     */     
/* 189 */     Assert.assertEquals(0L, this.courierOperation.getCouriersWithStatus(1).size());
/* 190 */     this.driveOperation.planingDrive(courierUsernameBG);
/* 191 */     Assert.assertTrue(this.courierOperation.getCouriersWithStatus(1).contains(courierUsernameBG));
/*     */     
/* 193 */     int type4 = 3;
...
/*     */     
/* 197 */     Assert.assertEquals(3L, this.packageOperations.getAllPackagesCurrentlyAtCity(BG).size());
/*     */     
...
/* 207 */     Assert.assertEquals(Integer.valueOf(1), this.driveOperation.getPackagesInVehicle(courierUsernameBG));
/*     */     
...
/*     */     
/* 264 */     Assert.assertEquals(2L, this.courierOperation.getCouriersWithStatus(0).size());
/*     */     
...
/*     */     
/* 273 */     Assert.assertTrue((this.courierOperation.getAverageCourierProfit(3).compareTo(profit.multiply(new BigDecimal(1.05D))) < 0));
/* 274 */     Assert.assertTrue((this.courierOperation.getAverageCourierProfit(3).compareTo(profit.multiply(new BigDecimal(0.95D))) > 0));
/*     */   }
/*     */ 
/*     */   
/*     */   @Test
...
/*     */     
/* 324 */     Assert.assertEquals(0L, this.courierOperation.getCouriersWithStatus(1).size());
/* 325 */     this.driveOperation.planingDrive(courierUsernameBG);
/* 326 */     this.driveOperation.planingDrive(courierUsernameVA);
/* 327 */     Assert.assertEquals(2L, this.courierOperation.getCouriersWithStatus(1).size());
/*     */     
...
/*     */     
/* 416 */     Assert.assertEquals(2L, this.courierOperation.getCouriersWithStatus(0).size());
/*     */     
/* 418 */     Assert.assertTrue((this.courierOperation.getAverageCourierProfit(1).compareTo(new BigDecimal(0)) > 0));
/* 419 */     Assert.assertTrue((this.courierOperation.getAverageCourierProfit(5).compareTo(new BigDecimal(0)) > 0));
/*     */   }
/*     */ }


/* Location:              C:\Users\CAR\Desktop\sab\SAB_projekat_1920\SAB_projekat_1920\SAB_projekat_1920.jar!\rs\etf\sab\tests\PublicModuleTest.class
